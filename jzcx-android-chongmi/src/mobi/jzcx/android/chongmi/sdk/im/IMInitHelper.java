package mobi.jzcx.android.chongmi.sdk.im;
...
import mobi.jzcx.android.chongmi.sdk.im.controller.EaseUI.EaseEmojiconInfoProvider;
import mobi.jzcx.android.chongmi.sdk.im.controller.EaseUI.EaseSettingsProvider;
import mobi.jzcx.android.chongmi.sdk.im.controller.EaseUI.EaseUserProfileProvider;
import mobi.jzcx.android.chongmi.sdk.im.db.DemoDBManager;
import mobi.jzcx.android.chongmi.sdk.im.db.InviteMessgeDao;
import mobi.jzcx.android.chongmi.sdk.im.db.UserDao;
import mobi.jzcx.android.chongmi.sdk.im.mode.DemoModel;
import mobi.jzcx.android.chongmi.sdk.im.mode.EaseEmojicon;
import mobi.jzcx.android.chongmi.sdk.im.mode.EaseEmojiconGroupEntity;
import mobi.jzcx.android.chongmi.sdk.im.mode.EaseNotifier;
import mobi.jzcx.android.chongmi.sdk.im.mode.EaseNotifier.EaseNotificationInfoProvider;
...
import mobi.jzcx.android.chongmi.sdk.im.mode.InviteMessage;
import mobi.jzcx.android.chongmi.sdk.im.mode.RobotUser;
import mobi.jzcx.android.chongmi.sdk.im.parse.UserProfileManager;
import mobi.jzcx.android.chongmi.sdk.im.utils.EaseCommonUtils;
import mobi.jzcx.android.chongmi.sdk.im.utils.EaseConstant;
import mobi.jzcx.android.chongmi.sdk.im.utils.PreferenceManager;
...
public class IMInitHelper {
	...
	protected static final String TAG = "IMInitHelper";
	...
	private static IMInitHelper instance = null;
	...
	public synchronized static IMInitHelper getInstance() {
		if (instance == null) {
			instance = new IMInitHelper();
		}
		return instance;
	}
	...
	protected void setGlobalListeners() {
			...
			public void onConnected() {
				...
				if (isGroupsSyncedWithServer && isContactsSyncedWithServer) {
					new Thread() {
						@Override
						public void run() {
							IMInitHelper.getInstance().notifyForRecevingEvents();
						}
					}.start();
				} else {
		...
		// IntentFilter(EMChatManager.getInstance().getIncomingCallBroadcastAction());
	...
	class MyGroupChangeListener implements EMGroupChangeListener {
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			// Intent(EaseConstant.ACTION_GROUP_CHANAGED));
		}
	...
	public class MyContactListener implements EMContactListener {
		...
		public void onContactDeleted(final List<String> usernameList) {
			// 被删除
			Map<String, EaseUser> localUsers = IMInitHelper.getInstance().getContactList();
			for (String username : usernameList) {
		...
		public void onContactInvited(String username, String reason) {
			...
			// notifyNewIviteMessage(msg);
			// broadcastManager.sendBroadcast(new
			// Intent(EaseConstant.ACTION_CONTACT_CHANAGED));
		}
	...
	protected void registerEventListener() {
		...
		EMChatManager.getInstance().registerEventListener(
				...
				new EMNotifierEvent.Event[]{EMNotifierEvent.Event.EventNewMessage,
						...
						EMNotifierEvent.Event.EventReadAck, EMNotifierEvent.Event.EventConversationListChanged});
	}

	private void UpdateMyMsgData(EMMessage message) {
		if (contactDao == null) {
