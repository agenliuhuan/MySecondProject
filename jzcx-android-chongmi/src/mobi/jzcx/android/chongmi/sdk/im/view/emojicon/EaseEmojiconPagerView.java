package mobi.jzcx.android.chongmi.sdk.im.view.emojicon;
...
import mobi.jzcx.android.chongmi.sdk.im.view.EmojiconGridAdapter;
import mobi.jzcx.android.chongmi.sdk.im.view.EmojiconPagerAdapter;
		...
		public void onPageSelected(int position) {
			...
			for (EaseEmojiconGroupEntity groupEntity : groupEntities) {
				...
				if (endSize + groupPageSize > position) {
					...
					// 当前group的pager切换
					if (pagerViewListener != null) {
						pagerViewListener.onGroupInnerPagePostionChanged(previousPagerPosition - endSize, position
								- endSize);
					}
					break;
