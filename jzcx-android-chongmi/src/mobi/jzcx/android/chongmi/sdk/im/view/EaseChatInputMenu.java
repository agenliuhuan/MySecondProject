...
import mobi.jzcx.android.chongmi.sdk.im.mode.EaseDefaultEmojiconDatas;
...
import mobi.jzcx.android.chongmi.sdk.im.view.emojicon.EaseEmojiconMenuBase;
import mobi.jzcx.android.chongmi.sdk.im.view.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
...
public class EaseChatInputMenu extends LinearLayout {
	...
	public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
		...
		if (chatPrimaryMenu == null) {
			chatPrimaryMenu = (EaseChatPrimaryMenu) layoutInflater
					.inflate(R.layout.ease_layout_chat_primary_menu, null);
		}
		...
		if (emojiconMenu == null) {
			...
			if (emojiconGroupList == null) {
				...
				emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.ee_1, Arrays
						.asList(EaseDefaultEmojiconDatas.getData())));
			}
			...
			public void onExpressionClicked(EaseEmojicon emojicon) {
				if (emojicon.getType() != EaseEmojicon.Type.BIG_EXPRESSION) {
					if (emojicon.getEmojiText() != null) {
						chatPrimaryMenu.onEmojiconInputEvent(EaseSmileUtils.getSmiledText(context,
