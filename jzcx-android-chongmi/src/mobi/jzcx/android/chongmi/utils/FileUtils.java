...
public class FileUtils {
	...
	public static final String APP = "chongmi";
	public static final String FAMILYSAFER = SDCARD + "/" + APP + "/";
	public static final String PICTURE = SDCARD + "/CMPicture/";
	...
	public static long getFolderSize(String strDirPath) {
		long size = 0;
		try {
