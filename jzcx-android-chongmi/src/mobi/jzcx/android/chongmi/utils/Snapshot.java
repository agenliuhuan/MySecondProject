...
public class Snapshot {
	...
	public void takePhoto(Activity act, String photoFilePath, int intentCode, int percent) {
		...
		// imageCaptureIntent.putExtra(MediaStore.EXTRA_SIZE_LIMIT, "720000");
	...
	private void cropImageUri(Activity act, Uri fromuri, Uri touri, int outputX, int outputY, int requestCode) {
