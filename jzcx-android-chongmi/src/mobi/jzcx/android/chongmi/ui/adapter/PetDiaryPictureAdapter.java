...
public class PetDiaryPictureAdapter extends BaseAdapter {
	...
	public PetDiaryPictureAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		params.width = (width - 150) / 4;
		params.height = (width - 150) / 4;
		...
		if (!CommonTextUtils.isEmpty(uriPath)) {
			if (uriPath.equals("addImage")) {
				...
				FrescoHelper.displayImageview(holder.image, "file://" + uriPath, 0, null, mContext.getResources(), true, 10.0f);
			}
