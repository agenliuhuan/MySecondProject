...
public class AccountPetAdapter extends BaseAdapter {
	ArrayList<PetObject> petList;
	Context mContext;

	public AccountPetAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null || convertView.getTag() == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.listitem_mypet, null);
	...
	class ViewHolder {
		...
		public ViewHolder(View view) {
			this.petImg = (SimpleDraweeView) view.findViewById(R.id.pet_image);
			this.petSex = (ImageView) view.findViewById(R.id.pet_gender);
			this.petName = (TextView) view.findViewById(R.id.pet_name);
			this.petCategory = (TextView) view.findViewById(R.id.pet_category);
			this.petBirthday = (TextView) view.findViewById(R.id.pet_birthday);
		}
	}
