...
public class AttentionAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null || convertView.getTag() == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.listitem_attention, null);
	...
	class ViewHolder {
		...
		public ViewHolder(View view) {
			this.avatar = (SimpleDraweeView) view.findViewById(R.id.attention_avatar);
			this.nameTv = (TextView) view.findViewById(R.id.attention_name);
			this.cityTv = (TextView) view.findViewById(R.id.attention_city);
			this.listPet = (HorizontalListView) view.findViewById(R.id.attention_pet);
			this.sexImage = (ImageView) view.findViewById(R.id.attention_sex);
		}
	}
