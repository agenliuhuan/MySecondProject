...
import mobi.jzcx.android.core.utils.DipPixelUtils;
...
public class YSToast {
	...
	public static void showLoginErrorToast(Context context) {
		if (mBasicToast == null) {
			mBasicToast = new Toast(context);
		}
		View toastView = LayoutInflater.from(context).inflate(R.layout.login_error_toast, null);
		mBasicToast.setView(toastView);
		mBasicToast.setGravity(Gravity.TOP, 0, 0);
