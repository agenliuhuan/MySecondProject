...
public class BluetoothLeService extends Service {
	...
	public final static String EXTRA_DATA_UUID = "com.example.bluetooth.le.EXTRA_DATA_UUID";
	...
	public void writeCharacteristic(BluetoothGattCharacteristic characteristic, String value) {
		...
		// byte b = Byte.parseByte(value, 16);
		// String a = Integer.toHexString(b & 0xFF);
		Log.i(TAG, "Uuid:  " + characteristic.getUuid().toString() + ";value:   " + value);
		...
		characteristic.setValue(HexUtil.decodeHex(value.toCharArray()));
		mBluetoothGatt.writeCharacteristic(characteristic);
	}
