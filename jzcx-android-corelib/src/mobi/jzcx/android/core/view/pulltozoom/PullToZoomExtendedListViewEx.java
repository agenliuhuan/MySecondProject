package mobi.jzcx.android.core.view.pulltozoom;

import mobi.jzcx.android.core.view.extendedlistview.ExtendedListView;
import mobi.jzcx.android.core.view.extendedlistview.ExtendedListView.OnPositionChangedListener;
 ...
 */
public class PullToZoomExtendedListViewEx extends PullToZoomBase<ExtendedListView> implements AbsListView.OnScrollListener {
	private static final String TAG = PullToZoomExtendedListViewEx.class.getSimpleName();
	...
	public PullToZoomExtendedListViewEx(Context context) {
		this(context, null);
	}

	public PullToZoomExtendedListViewEx(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	@Override
	protected ExtendedListView createRootView(Context context, AttributeSet attrs) {
		ExtendedListView lv = new ExtendedListView(context, attrs);
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (mZoomView != null && !isHideHeader() && isPullToZoomEnabled()) {
			...
			if (scrollListener != null) {
				scrollListener.scrollTo(Math.abs(mHeaderContainer.getTop()));
			}
		}
	}

	public void setOnPositionChangedListener(OnPositionChangedListener onPositionChangedListener) {
		mRootView.setOnPositionChangedListener(onPositionChangedListener);
	}
		...
		public void run() {
			if (mZoomView != null) {
				...
				if ((!mIsFinished) && (mScale > 1.0D)) {
					...
					f2 = mScale - (mScale - 1.0F) * PullToZoomExtendedListViewEx.sInterpolator.getInterpolation(f1);
