...
package mobi.jzcx.android.core.net.http.client;
...
import mobi.jzcx.android.core.net.http.request.AsyncHttpRequest;
...
import mobi.jzcx.android.core.net.http.request.RetryHandler;
import mobi.jzcx.android.core.utils.ThreadPool;
...
public class AsyncHttpClient {
	 ...
	 */
	public AsyncHttpClient() throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
	...
	public void get(Context context, String url, Header[] headers, RequestParams params, AsyncHttpResponseHandler responseHandler) {
		get(context, url, headers, params, responseHandler, socketTimeout, socketTimeout);
	}

	public void get(Context context, String url, Header[] headers, RequestParams params, AsyncHttpResponseHandler responseHandler, int connectionTimeout,
			int soTimeout) {
		try {
			...
			HttpConnectionParams.setConnectionTimeout(httpParams, connectionTimeout); // 设置连接超时
	...
	public void post(Context context, String url, Header[] headers, RequestParams params, String contentType, AsyncHttpResponseHandler responseHandler) {
		post(context, url, headers, paramsToEntity(params), contentType, responseHandler);
	}
	...
	public void post(Context context, String url, Header[] headers, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler) {
		...
		post(context, url, headers, entity, contentType, responseHandler, socketTimeout, socketTimeout);
	}
