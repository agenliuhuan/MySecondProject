 ...
 * This is a wrapper to allow multiple threads to iterate across the same dao or
 * the same lazy collection at the same time. See
 * {@link Dao#getWrappedIterable()} or
 * {@link ForeignCollection#getWrappedIterable()}.
 * 
 * @author graywatson
 */
