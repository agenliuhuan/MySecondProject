...
public class VersionUtils {
	...
	/**
	 * Verifies that the ormlite-core and -jdbc version files hold the same
	 * string.
	 */
	...
	/**
	 * Verifies that the ormlite-core and -android version files hold the same
	 * string.
	 */
	...
	/**
	 * Get the logger for the class. We do this so we don't have to create it
	 * all of the time.
	 */
