package mobi.jzcx.android.core.ormlite.android.compat;

import android.os.Build;

/**
 * Utility class which loads the various classes based on which API version is
 * being supported.
 * 
 * @author graywatson
 */
...
public class ApiCompatibilityUtils {
	...
	/**
	 * Copied from {@link Build.VERSION_CODES}. We don't use those codes because
	 * they won't be in certain versions of Build.
	 */
