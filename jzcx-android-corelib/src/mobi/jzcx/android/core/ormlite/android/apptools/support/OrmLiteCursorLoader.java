package mobi.jzcx.android.core.ormlite.android.apptools.support;

import java.sql.SQLException;

import mobi.jzcx.android.core.ormlite.android.AndroidCompiledStatement;
...
/**
 * Cursor loader supported by later Android APIs that allows asynchronous
 * content loading.
 * 
 * <p>
 * <b>NOTE:</b> This should be the <i>same</i> as
 * {@link com.j256.ormlite.android.apptools.OrmLiteCursorLoader} but this should
 * import the support library version of the {@link AsyncTaskLoader}.
 * </p>
 * 
 * @author emmby
 */
public class OrmLiteCursorLoader<T> extends AsyncTaskLoader<Cursor> implements DaoObserver {
	...
	public Cursor loadInBackground() {
		...
		try {
			...
			AndroidCompiledStatement statement = (AndroidCompiledStatement) query.compile(connection,
